...
@EnableJpaRepositories(
        ...
        basePackages = {"com.ca.formation.formationdemo1.repositories"})
 */
public class DbConfig {
    ...
    public LocalContainerEntityManagerFactoryBean primaryEntityManagerFactory
        ...
        return builder.dataSource(primaryDataSource).packages("com.ca.formation.formationdemo1.repositories").build();
    }
